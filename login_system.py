import csv,random,string,sys,base64
...
def randompass():
    while True:
        ...
        if N>=5:
            ...
            print("Note down the generated password:  ",password)
            return password
        else:
            print("Invalid")
...
def write_csv(use,password):
    with open('D:\\Workspace\\Python\\Login System\\login_details.csv','a', newline='') as filew1:
...
def check(usertmp):
    x=""
    with open('D:\\Workspace\\Python\\Login System\\login_details.csv','r', newline='') as filer1:
...
def checkuserpass(username,password):
    with open('D:\\Workspace\\Python\\Login System\\login_details.csv','r', newline='') as filer2:
...
def trying():
    try:
        with open('D:\\Workspace\\Python\\Login System\\login_details.csv','r', newline='') as filer3:
            reader3=csv.DictReader(filer3)
    except FileNotFoundError:
        with open('D:\\Workspace\\Python\\Login System\\login_details.csv','w', newline='') as filew3:
            fieldnames=['Username', 'Password']
